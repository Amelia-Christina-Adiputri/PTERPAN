...
<img class="align-self-center mr-3" src="https://www.ukdw.ac.id/public_html/wp-content/uploads/2017/10/logo-ukdw.png" alt="Generic placeholder image" width="40" height="50">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                <a class="nav-link {{($key=='Home') ? 'active':''}}"  href="/p_home">Home</a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{($key=='Driver') ? 'active':''}}"  href="/p_driver">Daftar Driver</a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{($key=='Kendaraan') ? 'active':''}}"  href="/p_kendaraan">Daftar Kendaraan</a>
            </li>
        </ul>
